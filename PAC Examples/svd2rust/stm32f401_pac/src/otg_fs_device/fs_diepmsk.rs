...
pub struct R(crate::R<FS_DIEPMSK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_DIEPMSK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_DIEPMSK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_DIEPMSK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_DIEPMSK` writer"]
pub struct W(crate::W<FS_DIEPMSK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_DIEPMSK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_DIEPMSK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_DIEPMSK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFRCM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
...
pub type EPDM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
...
pub type TOM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
...
pub type ITTXFEMSK_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
...
pub type INEPNMM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
...
pub type INEPNEM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_DIEPMSK_SPEC, bool, O>;
impl R {

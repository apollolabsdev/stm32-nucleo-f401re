...
pub struct R(crate::R<FS_DAINT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_DAINT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_DAINT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_DAINT_SPEC>) -> Self {
        R(reader)
    }
}

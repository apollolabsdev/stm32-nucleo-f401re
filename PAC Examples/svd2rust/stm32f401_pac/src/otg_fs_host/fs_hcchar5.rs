...
pub struct R(crate::R<FS_HCCHAR5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCCHAR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCCHAR5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCCHAR5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCCHAR5` writer"]
pub struct W(crate::W<FS_HCCHAR5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCCHAR5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCCHAR5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCCHAR5_SPEC>) -> Self {
        W(writer)
    }
}

...
pub struct R(crate::R<FS_HCINT5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCINT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCINT5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCINT5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCINT5` writer"]
pub struct W(crate::W<FS_HCINT5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCINT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCINT5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCINT5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINT5_SPEC, bool, O>;

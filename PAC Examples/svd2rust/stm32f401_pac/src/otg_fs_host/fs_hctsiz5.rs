...
pub struct R(crate::R<FS_HCTSIZ5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCTSIZ5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCTSIZ5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCTSIZ5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCTSIZ5` writer"]
pub struct W(crate::W<FS_HCTSIZ5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCTSIZ5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCTSIZ5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCTSIZ5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFRSIZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FS_HCTSIZ5_SPEC, u32, u32, 19, O>;
#[doc = "Field `PKTCNT` reader - Packet count"]
pub type PKTCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PKTCNT` writer - Packet count"]
pub type PKTCNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FS_HCTSIZ5_SPEC, u16, u16, 10, O>;
#[doc = "Field `DPID` reader - Data PID"]
pub type DPID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DPID` writer - Data PID"]
pub type DPID_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FS_HCTSIZ5_SPEC, u8, u8, 2, O>;
impl R {

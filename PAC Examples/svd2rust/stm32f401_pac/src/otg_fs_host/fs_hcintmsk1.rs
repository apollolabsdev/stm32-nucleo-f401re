...
pub struct R(crate::R<FS_HCINTMSK1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCINTMSK1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCINTMSK1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCINTMSK1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCINTMSK1` writer"]
pub struct W(crate::W<FS_HCINTMSK1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCINTMSK1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCINTMSK1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCINTMSK1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type XFRCM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
#[doc = "Field `CHHM` reader - Channel halted mask"]
pub type CHHM_R = crate::BitReader<bool>;
#[doc = "Field `CHHM` writer - Channel halted mask"]
pub type CHHM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type STALLM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type NAKM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type ACKM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type NYET_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type TXERRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
#[doc = "Field `BBERRM` reader - Babble error mask"]
pub type BBERRM_R = crate::BitReader<bool>;
#[doc = "Field `BBERRM` writer - Babble error mask"]
pub type BBERRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type FRMORM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
...
pub type DTERRM_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINTMSK1_SPEC, bool, O>;
impl R {

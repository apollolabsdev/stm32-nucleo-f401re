#[doc = "Register `FS_HCINT4` reader"]
pub struct R(crate::R<FS_HCINT4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HCINT4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HCINT4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HCINT4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HCINT4` writer"]
pub struct W(crate::W<FS_HCINT4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HCINT4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HCINT4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HCINT4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NAK_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HCINT4_SPEC, bool, O>;
...
#[doc = "OTG_FS host channel-4 interrupt register (OTG_FS_HCINT4)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fs_hcint4](index.html) module"]
pub struct FS_HCINT4_SPEC;
impl crate::RegisterSpec for FS_HCINT4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fs_hcint4::R](R) reader structure"]
impl crate::Readable for FS_HCINT4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [fs_hcint4::W](W) writer structure"]
impl crate::Writable for FS_HCINT4_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets FS_HCINT4 to value 0"]
impl crate::Resettable for FS_HCINT4_SPEC {

...
pub struct R(crate::R<FS_HPRT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_HPRT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_HPRT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_HPRT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FS_HPRT` writer"]
pub struct W(crate::W<FS_HPRT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FS_HPRT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FS_HPRT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FS_HPRT_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PCDET_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HPRT_SPEC, bool, O>;
#[doc = "Field `PENA` reader - Port enable"]
pub type PENA_R = crate::BitReader<bool>;
#[doc = "Field `PENA` writer - Port enable"]
pub type PENA_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HPRT_SPEC, bool, O>;
...
pub type PENCHNG_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HPRT_SPEC, bool, O>;
...
pub type PPWR_W<'a, const O: u8> = crate::BitWriter<'a, u32, FS_HPRT_SPEC, bool, O>;
#[doc = "Field `PTCTL` reader - Port test control"]
pub type PTCTL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PTCTL` writer - Port test control"]
pub type PTCTL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FS_HPRT_SPEC, u8, u8, 4, O>;

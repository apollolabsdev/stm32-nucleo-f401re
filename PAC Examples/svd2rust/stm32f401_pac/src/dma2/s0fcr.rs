...
pub type FTH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, S0FCR_SPEC, u8, u8, 2, O>;
...
pub type DMDIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, S0FCR_SPEC, bool, O>;
...
pub type FEIE_W<'a, const O: u8> = crate::BitWriter<'a, u32, S0FCR_SPEC, bool, O>;
impl R {

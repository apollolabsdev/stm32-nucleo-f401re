...
pub struct R(crate::R<FS_GRXSTSR_DEVICE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_GRXSTSR_DEVICE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_GRXSTSR_DEVICE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_GRXSTSR_DEVICE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "OTG_FS Receive status debug read(Device mode)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fs_grxstsr_device](index.html) module"]

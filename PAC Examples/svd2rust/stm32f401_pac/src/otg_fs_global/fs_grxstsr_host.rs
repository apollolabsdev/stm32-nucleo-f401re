...
pub struct R(crate::R<FS_GRXSTSR_HOST_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FS_GRXSTSR_HOST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FS_GRXSTSR_HOST_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FS_GRXSTSR_HOST_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "OTG_FS Receive status debug read(Host mode)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [fs_grxstsr_host](index.html) module"]
pub struct FS_GRXSTSR_HOST_SPEC;
impl crate::RegisterSpec for FS_GRXSTSR_HOST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [fs_grxstsr_host::R](R) reader structure"]
impl crate::Readable for FS_GRXSTSR_HOST_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets FS_GRXSTSR_Host to value 0"]
impl crate::Resettable for FS_GRXSTSR_HOST_SPEC {

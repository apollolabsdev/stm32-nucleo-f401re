...
pub struct R(crate::R<DBGMCU_IDCODE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DBGMCU_IDCODE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DBGMCU_IDCODE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DBGMCU_IDCODE_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "IDCODE\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dbgmcu_idcode](index.html) module"]

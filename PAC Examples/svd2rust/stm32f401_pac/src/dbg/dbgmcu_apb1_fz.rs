...
pub struct R(crate::R<DBGMCU_APB1_FZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DBGMCU_APB1_FZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DBGMCU_APB1_FZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DBGMCU_APB1_FZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DBGMCU_APB1_FZ` writer"]
pub struct W(crate::W<DBGMCU_APB1_FZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DBGMCU_APB1_FZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DBGMCU_APB1_FZ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DBGMCU_APB1_FZ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DBG_TIM2_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
pub type DBG_TIM3_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
pub type DBG_TIM4_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
pub type DBG_TIM5_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
pub type DBG_RTC_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
pub type DBG_WWDG_STOP_W<'a, const O: u8> = crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
#[doc = "Field `DBG_IWDEG_STOP` reader - DBG_IWDEG_STOP"]
pub type DBG_IWDEG_STOP_R = crate::BitReader<bool>;
#[doc = "Field `DBG_IWDEG_STOP` writer - DBG_IWDEG_STOP"]
pub type DBG_IWDEG_STOP_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, DBGMCU_APB1_FZ_SPEC, bool, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dbg_iwdeg_stop(&mut self) -> DBG_IWDEG_STOP_W<12> {
        DBG_IWDEG_STOP_W::new(self)
    }
    #[doc = "Bit 21 - DBG_J2C1_SMBUS_TIMEOUT"]
    #[inline(always)]
    #[must_use]
